...
public class PlayerTank extends Tank {
    ...
    protected class Healing extends Skill{
    ...
    protected class OctopusCannon extends Skill {
    ...
    protected class LineShoot extends Skill {
    ...
    protected class LongDistanceShoot extends Skill implements ReleaseKeySkill, BlockShootSkill {
